...
| 项目 | Star | 描述 |
| ---- | ---- | ---- |
| [freeCodeCamp/freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp) | ⭐ 431k | freeCodeCamp.org's open-source codebase and curriculum. Learn math, programming, and computer science for free. |
| [sindresorhus/awesome](https://github.com/sindresorhus/awesome) | ⭐ 413k | 😎 Awesome lists about all kinds of interesting topics |
| [public-apis/public-apis](https://github.com/public-apis/public-apis) | ⭐ 377k | A collective list of free APIs |
...
| [vinta/awesome-python](https://github.com/vinta/awesome-python) | ⭐ 269k | An opinionated list of awesome Python frameworks, libraries, software and resources. |
...
| [jackfrued/Python-100-Days](https://github.com/jackfrued/Python-100-Days) | ⭐ 174k | Python - 100天从新手到大师 |
...
| [n8n-io/n8n](https://github.com/n8n-io/n8n) | ⭐ 155k | Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations. |
...
| [langgenius/dify](https://github.com/langgenius/dify) | ⭐ 118k | Production-ready platform for agentic workflow development. |
...
| [rustdesk/rustdesk](https://github.com/rustdesk/rustdesk) | ⭐ 102k | An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer. |
| [shadcn-ui/ui](https://github.com/shadcn-ui/ui) | ⭐ 99k | A set of beautifully-designed, accessible components and a code distribution platform. Works with your favorite frameworks. Open Source. Open Code. |
...
| [comfyanonymous/ComfyUI](https://github.com/comfyanonymous/ComfyUI) | ⭐ 93k | The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface. |
...
| [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) | ⭐ 67k | 🔥 The Web Data API for AI - Turn entire websites into LLM-ready markdown or structured data |
...
| [Zie619/n8n-workflows](https://github.com/Zie619/n8n-workflows) | ⭐ 39k | all of the workflows of n8n i could find (also from the site itself) |
...
| [hangwin/mcp-chrome](https://github.com/hangwin/mcp-chrome) | ⭐ 9.2k | Chrome MCP Server is a Chrome extension-based Model Context Protocol (MCP) server that exposes your Chrome browser functionality to AI assistants like Claude, enabling complex browser automation, content analysis, and semantic search. |
...
| [unovue/shadcn-vue](https://github.com/unovue/shadcn-vue) | ⭐ 8.6k | Vue port of shadcn-ui |
...
| [dreammis/social-auto-upload](https://github.com/dreammis/social-auto-upload) | ⭐ 7.2k | 自动化上传视频到社交媒体：抖音、小红书、视频号、tiktok、youtube、bilibili |
...
| [wordshub/free-font](https://github.com/wordshub/free-font) | ⭐ 5.8k | 大概是2020年最全的免费可商用字体，这里收录的商免字体都能找到明确的授权出处，可以放心使用，持续更新中... |
...
| [zyronon/TypeWords](https://github.com/zyronon/TypeWords) | ⭐ 5.2k | 练习英语，一次敲击，一点进步；Practice English, one strike, one step forward |
...
| [unovue/inspira-ui](https://github.com/unovue/inspira-ui) | ⭐ 4.2k | Build beautiful website using Vue & Nuxt. |
...
| [youhunwl/TVAPP](https://github.com/youhunwl/TVAPP) | ⭐ 4.0k |  收集全网 Android TV电视盒子应用，涵盖影视、直播、K歌、工具、游戏等类型，整理优质APK资源，支持便捷下载与自动更新。提供安全验证、分类索引与兼容性标注，助力用户打造家庭影音娱乐中心！              ✅ TVBox/影视仓等影音壳接口配置源。 |
...
| [liu-ziting/what-to-eat](https://github.com/liu-ziting/what-to-eat) | ⭐ 2.4k | 一饭封神：一个基于 AI 的智能菜谱生成平台，支持中华八大菜系 + 国际料理，提供营养分析、酒水推荐、菜谱效果图生成等全方位烹饪指导。 |
...
| [vue-final/vue-final-modal](https://github.com/vue-final/vue-final-modal) | ⭐ 996 | 🍕Vue Final Modal is a tiny, renderless, mobile-friendly, feature-rich modal component for Vue.js. |
...
| [neovateai/neovate-code](https://github.com/neovateai/neovate-code) | ⭐ 990 | Neovate Code is a code agent to enhance your development. You can use it to generate code, fix bugs, review code, add tests, and more. You can run it in interactive mode or headless mode. |
| [antfu/antfu.me](https://github.com/antfu/antfu.me) | ⭐ 976 | My personal website |
| [antfu/changelogithub](https://github.com/antfu/changelogithub) | ⭐ 870 | Generate changelog for GitHub |
| [antfu/utils](https://github.com/antfu/utils) | ⭐ 867 | Collection of common JavaScript / TypeScript utils |
| [antfu/starter-ts](https://github.com/antfu/starter-ts) | ⭐ 851 | Starter template for TypeScript library |
...
| [kermanx/reactive-vscode](https://github.com/kermanx/reactive-vscode) | ⭐ 794 | Vue Reactivity for VSCode Extension API |
| [klover2/wechatpay-node-v3-ts](https://github.com/klover2/wechatpay-node-v3-ts) | ⭐ 743 | 微信支付v3 |
| [jaaronkot/picprose](https://github.com/jaaronkot/picprose) | ⭐ 740 | Better cover image generator tool for Medium, Blog, Youtube, BiliBili and many others |
| [sail-sail/ejsExcel](https://github.com/sail-sail/ejsExcel) | ⭐ 718 | nodejs excel template engine. node export excel |
| [SnowingFox/open-nof1.ai](https://github.com/SnowingFox/open-nof1.ai) | ⭐ 687 | A opensource AI trading platform in real market, |
| [uiwjs/react-login-page](https://github.com/uiwjs/react-login-page) | ⭐ 672 | Some `react` login pages, which can be used quickly after installation. |
...
| [worryzyy/HowToCook-mcp](https://github.com/worryzyy/HowToCook-mcp) | ⭐ 646 | 基于Anduin2017 / HowToCook （程序员在家做饭指南）的mcp server |
| [chibivue-land/chibivue](https://github.com/chibivue-land/chibivue) | ⭐ 639 | chibivue is a minimal vuejs/core implementations (reactivity, virtual dom, component runtime, compiler). An online book for building your own Vue.js. |
| [BayBreezy/ui-thing](https://github.com/BayBreezy/ui-thing) | ⭐ 574 | A modern set of Nuxt components built with Reka UI & TailwindCSS. Inspired by shadcn/ui & shadcn-vue. |
...
| [MrWangJustToDo/git-diff-view](https://github.com/MrWangJustToDo/git-diff-view) | ⭐ 537 | A Diff View component for React / Vue / Solid / Svelte / Ink, same as Github |
| [antfu-collective/birpc](https://github.com/antfu-collective/birpc) | ⭐ 524 | Message-based two-way remote procedure call. |
| [dianprata/nuxt-shadcn-dashboard](https://github.com/dianprata/nuxt-shadcn-dashboard) | ⭐ 519 | Template Dashboard with Nuxt 4 + Shadcn + TailwindCSS 4  |
| [ImgEdify/Awesome-GPT4o-Image-Prompts](https://github.com/ImgEdify/Awesome-GPT4o-Image-Prompts) | ⭐ 491 | 📚 GPT4o Prompts Dictionary \| Curated Collection of AI Image Generation Prompts |
| [antfu/starter-vscode](https://github.com/antfu/starter-vscode) | ⭐ 488 | Starter template for VS Code Extension |
| [ddiu8081/bus-vis](https://github.com/ddiu8081/bus-vis) | ⭐ 486 | 🚌 City bus visualizations of China. |
| [espressif/esp-brookesia](https://github.com/espressif/esp-brookesia) | ⭐ 473 | ESP-Brookesia is a human-machine interaction development framework designed for AIoT devices. |
| [zebra-ui/zebra-swiper](https://github.com/zebra-ui/zebra-swiper) | ⭐ 435 | 兼容多端的高性能轮播组件库，支持多种复杂的 3D 轮播效果。 |
...
| [junian/markdown-resume](https://github.com/junian/markdown-resume) | ⭐ 329 | ATS and Human-friendly Resume Writer in Markdown. |
...
| [open-dingtalk/dingtalk-pierced-client](https://github.com/open-dingtalk/dingtalk-pierced-client) | ⭐ 254 | 钉钉内网穿透客户端，鉴于很多开发者在临时体验开发时往往没有公网域名或者公网IP，本工具提供了一个公网代理服务，目的是方便开发测试，仅用于开发测试过程，不可用于线上生产环境。 |
...
| [howoii/SmartBookmark](https://github.com/howoii/SmartBookmark) | ⭐ 213 | 一款基于 AI 的智能书签管理插件 |
...
| [antfu/vite-plugin-restart](https://github.com/antfu/vite-plugin-restart) | ⭐ 201 | Custom files/globs to restart Vite server |
...
| [antfu/structured-clone-es](https://github.com/antfu/structured-clone-es) | ⭐ 33 | A redistribution of @ungap/structured-clone that ships Node.js compatible ESM. |
