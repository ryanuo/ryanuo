...
| 项目 | Star | 描述 |
| ---- | ---- | ---- |
| [freeCodeCamp/freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp) | ⭐ 433k | freeCodeCamp.org's open-source codebase and curriculum. Learn math, programming, and computer science for free. |
| [sindresorhus/awesome](https://github.com/sindresorhus/awesome) | ⭐ 417k | 😎 Awesome lists about all kinds of interesting topics |
| [public-apis/public-apis](https://github.com/public-apis/public-apis) | ⭐ 380k | A collective list of free APIs |
...
| [vinta/awesome-python](https://github.com/vinta/awesome-python) | ⭐ 271k | An opinionated list of awesome Python frameworks, libraries, software and resources. |
...
| [trekhleb/javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) | ⭐ 194k | 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings |
| [microsoft/vscode](https://github.com/microsoft/vscode) | ⭐ 179k | Visual Studio Code |
| [jackfrued/Python-100-Days](https://github.com/jackfrued/Python-100-Days) | ⭐ 175k | Python - 100天从新手到大师 |
| [AUTOMATIC1111/stable-diffusion-webui](https://github.com/AUTOMATIC1111/stable-diffusion-webui) | ⭐ 158k | Stable Diffusion web UI |
| [n8n-io/n8n](https://github.com/n8n-io/n8n) | ⭐ 158k | Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations. |
| [ollama/ollama](https://github.com/ollama/ollama) | ⭐ 156k | Get up and running with OpenAI gpt-oss, DeepSeek-R1, Gemma 3 and other models. |
...
| [open-webui/open-webui](https://github.com/open-webui/open-webui) | ⭐ 116k | User-friendly AI Interface (Supports Ollama, OpenAI API, ...) |
...
| [comfyanonymous/ComfyUI](https://github.com/comfyanonymous/ComfyUI) | ⭐ 94k | The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface. |
...
| [ChatGPTNextWeb/NextChat](https://github.com/ChatGPTNextWeb/NextChat) | ⭐ 86k | ✨ Light and Fast AI Assistant. Support: Web \| iOS \| MacOS \| Android \|  Linux \| Windows |
...
| [ruanyf/weekly](https://github.com/ruanyf/weekly) | ⭐ 79k | 科技爱好者周刊，每周五发布 |
...
| [Stirling-Tools/Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF) | ⭐ 70k | #1 Locally hosted web application that allows you to perform various operations on PDF files |
| [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) | ⭐ 68k | 🔥 The Web Data API for AI - Turn entire websites into LLM-ready markdown or structured data |
...
| [Zie619/n8n-workflows](https://github.com/Zie619/n8n-workflows) | ⭐ 44k | all of the workflows of n8n i could find (also from the site itself) |
...
| [chatboxai/chatbox](https://github.com/chatboxai/chatbox) | ⭐ 38k | User-friendly Desktop Client App for AI Models/LLMs (GPT, Claude, Gemini, Ollama...) |
...
| [langbot-app/LangBot](https://github.com/langbot-app/LangBot) | ⭐ 14k | 🤩 Production-grade  platform for building IM bots / 生产级即时通信机器人开发平台 ⚡️ Bots for QQ / QQ频道 / Discord / LINE / WeChat(微信, 企业微信)/ Telegram / 飞书 / 钉钉 / Slack 🧩 Integrated with ChatGPT(GPT), DeepSeek, Dify, n8n, Langflow, Coze, Claude, Google Gemini, Nano Banana, Kimi, PPIO, Ollama, MiniMax, SiliconFlow, Qwen, Moonshot, MCP etc. LLM & Agent & RAG |
...
| [hangwin/mcp-chrome](https://github.com/hangwin/mcp-chrome) | ⭐ 9.3k | Chrome MCP Server is a Chrome extension-based Model Context Protocol (MCP) server that exposes your Chrome browser functionality to AI assistants like Claude, enabling complex browser automation, content analysis, and semantic search. |
...
| [unovue/shadcn-vue](https://github.com/unovue/shadcn-vue) | ⭐ 8.7k | Vue port of shadcn-ui |
...
| [dreammis/social-auto-upload](https://github.com/dreammis/social-auto-upload) | ⭐ 7.4k | 自动化上传视频到社交媒体：抖音、小红书、视频号、tiktok、youtube、bilibili |
...
| [bubkoo/html-to-image](https://github.com/bubkoo/html-to-image) | ⭐ 6.8k | ✂️ Generates an image from a DOM node using HTML5 canvas and SVG. |
...
| [nuxt/ui](https://github.com/nuxt/ui) | ⭐ 5.8k | The Intuitive Vue UI Library powered by Reka UI & Tailwind CSS. |
...
| [zyronon/TypeWords](https://github.com/zyronon/TypeWords) | ⭐ 5.6k | 练习英语，一次敲击，一点进步；Practice English, one strike, one step forward |
...
| [youhunwl/TVAPP](https://github.com/youhunwl/TVAPP) | ⭐ 4.6k |  收集全网 Android TV电视盒子应用，涵盖影视、直播、K歌、工具、游戏等类型，整理优质APK资源，支持便捷下载与自动更新。提供安全验证、分类索引与兼容性标注，助力用户打造家庭影音娱乐中心！              ✅ TVBox/影视仓等影音壳接口配置源。 |
...
| [vercel/streamdown](https://github.com/vercel/streamdown) | ⭐ 3.1k | A drop-in replacement for react-markdown, designed for AI-powered streaming. |
...
| [vue-final/vue-final-modal](https://github.com/vue-final/vue-final-modal) | ⭐ 999 | 🍕Vue Final Modal is a tiny, renderless, mobile-friendly, feature-rich modal component for Vue.js. |
...
| [antfu/antfu.me](https://github.com/antfu/antfu.me) | ⭐ 982 | My personal website |
| [antfu/changelogithub](https://github.com/antfu/changelogithub) | ⭐ 874 | Generate changelog for GitHub |
| [antfu/utils](https://github.com/antfu/utils) | ⭐ 868 | Collection of common JavaScript / TypeScript utils |
| [antfu/starter-ts](https://github.com/antfu/starter-ts) | ⭐ 856 | Starter template for TypeScript library |
...
| [kermanx/reactive-vscode](https://github.com/kermanx/reactive-vscode) | ⭐ 796 | Vue Reactivity for VSCode Extension API |
| [klover2/wechatpay-node-v3-ts](https://github.com/klover2/wechatpay-node-v3-ts) | ⭐ 750 | 微信支付v3 |
| [jaaronkot/picprose](https://github.com/jaaronkot/picprose) | ⭐ 741 | Better cover image generator tool for Medium, Blog, Youtube, BiliBili and many others |
| [SnowingFox/open-nof1.ai](https://github.com/SnowingFox/open-nof1.ai) | ⭐ 732 | A opensource AI trading platform in real market, |
| [sail-sail/ejsExcel](https://github.com/sail-sail/ejsExcel) | ⭐ 719 | nodejs excel template engine. node export excel |
| [uiwjs/react-login-page](https://github.com/uiwjs/react-login-page) | ⭐ 674 | Some `react` login pages, which can be used quickly after installation. |
...
| [worryzyy/HowToCook-mcp](https://github.com/worryzyy/HowToCook-mcp) | ⭐ 655 | 基于Anduin2017 / HowToCook （程序员在家做饭指南）的mcp server |
| [chibivue-land/chibivue](https://github.com/chibivue-land/chibivue) | ⭐ 640 | chibivue is a minimal vuejs/core implementations (reactivity, virtual dom, component runtime, compiler). An online book for building your own Vue.js. |
| [BayBreezy/ui-thing](https://github.com/BayBreezy/ui-thing) | ⭐ 582 | A modern set of Nuxt components built with Reka UI & TailwindCSS. Inspired by shadcn/ui & shadcn-vue. |
...
| [MrWangJustToDo/git-diff-view](https://github.com/MrWangJustToDo/git-diff-view) | ⭐ 546 | A Diff View component for React / Vue / Solid / Svelte / Ink, same as Github |
| [cheeaun/puppetron](https://github.com/cheeaun/puppetron) | ⭐ 544 | Puppeteer (Headless Chrome Node API)-based rendering solution. |
| [dianprata/nuxt-shadcn-dashboard](https://github.com/dianprata/nuxt-shadcn-dashboard) | ⭐ 544 | Template Dashboard with Nuxt 4 + Shadcn + TailwindCSS 4  |
| [antfu-collective/birpc](https://github.com/antfu-collective/birpc) | ⭐ 531 | Message-based two-way remote procedure call. |
| [ImgEdify/Awesome-GPT4o-Image-Prompts](https://github.com/ImgEdify/Awesome-GPT4o-Image-Prompts) | ⭐ 494 | 📚 GPT4o Prompts Dictionary \| Curated Collection of AI Image Generation Prompts |
| [antfu/starter-vscode](https://github.com/antfu/starter-vscode) | ⭐ 492 | Starter template for VS Code Extension |
| [ddiu8081/bus-vis](https://github.com/ddiu8081/bus-vis) | ⭐ 487 | 🚌 City bus visualizations of China. |
| [espressif/esp-brookesia](https://github.com/espressif/esp-brookesia) | ⭐ 485 | ESP-Brookesia is a human-machine interaction development framework designed for AIoT devices. |
| [zebra-ui/zebra-swiper](https://github.com/zebra-ui/zebra-swiper) | ⭐ 437 | 兼容多端的高性能轮播组件库，支持多种复杂的 3D 轮播效果。 |
...
| [junian/markdown-resume](https://github.com/junian/markdown-resume) | ⭐ 347 | ATS and Human-friendly Resume Writer in Markdown. |
| [reslear/tailwind-scrollbar-hide](https://github.com/reslear/tailwind-scrollbar-hide) | ⭐ 301 | tailwindcss plugin for hide scrollbar |
...
| [howoii/SmartBookmark](https://github.com/howoii/SmartBookmark) | ⭐ 219 | 一款基于 AI 的智能书签管理插件 |
| [ElementUI/theme-chalk-preview](https://github.com/ElementUI/theme-chalk-preview) | ⭐ 219 | Preview and download custom theme-chalk. |
| [Alanrk/TabMark-Bookmark-New-Tab](https://github.com/Alanrk/TabMark-Bookmark-New-Tab) | ⭐ 216 | TabMark是一款基于书签的新标签页插件，将你的收藏夹变成新标签页，让你收藏的书签一目了然、整洁高效，快速直达你最需要的网站和资源。搭配智能 AI 搜索，更快找到你想要的答案。支持 Chrome 和 Edge。 |
