...
自动生成于 11/17/2025, 1:24:14 AM。


| 项目 | Star | 描述 |
| ---- | ---- | ---- |
| [freeCodeCamp/freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp) | ⭐ 432k | freeCodeCamp.org's open-source codebase and curriculum. Learn math, programming, and computer science for free. |
| [sindresorhus/awesome](https://github.com/sindresorhus/awesome) | ⭐ 415k | 😎 Awesome lists about all kinds of interesting topics |
| [public-apis/public-apis](https://github.com/public-apis/public-apis) | ⭐ 379k | A collective list of free APIs |
...
| [vinta/awesome-python](https://github.com/vinta/awesome-python) | ⭐ 270k | An opinionated list of awesome Python frameworks, libraries, software and resources. |
...
| [torvalds/linux](https://github.com/torvalds/linux) | ⭐ 207k | Linux kernel source tree |
...
| [n8n-io/n8n](https://github.com/n8n-io/n8n) | ⭐ 157k | Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations. |
...
| [langgenius/dify](https://github.com/langgenius/dify) | ⭐ 119k | Production-ready platform for agentic workflow development. |
...
| [open-webui/open-webui](https://github.com/open-webui/open-webui) | ⭐ 115k | User-friendly AI Interface (Supports Ollama, OpenAI API, ...) |
...
| [shadcn-ui/ui](https://github.com/shadcn-ui/ui) | ⭐ 100k | A set of beautifully-designed, accessible components and a code distribution platform. Works with your favorite frameworks. Open Source. Open Code. |
...
| [immich-app/immich](https://github.com/immich-app/immich) | ⭐ 84k | High performance self-hosted photo and video management solution. |
...
| [Zie619/n8n-workflows](https://github.com/Zie619/n8n-workflows) | ⭐ 41k | all of the workflows of n8n i could find (also from the site itself) |
...
| [langbot-app/LangBot](https://github.com/langbot-app/LangBot) | ⭐ 14k | 🤩 Easy-to-use global IM bot platform designed for LLM era / 简单易用的大模型即时通信机器人开发平台 ⚡️ Bots for QQ / QQ频道 / Discord / LINE / WeChat(微信, 企业微信)/ Telegram / 飞书 / 钉钉 / Slack 🧩 Integrated with ChatGPT(GPT), DeepSeek, Dify, n8n, Langflow, Coze, Claude, Google Gemini, xAI, PPIO, Ollama, MiniMax, SiliconFlow, Qwen, Moonshot, MCP etc. LLM & Agent & RAG |
...
| [QuantumNous/new-api](https://github.com/QuantumNous/new-api) | ⭐ 12k | AI模型聚合管理中转分发系统，一个应用管理您的所有AI模型，支持将多种大模型转为统一格式调用，支持OpenAI、Claude、Gemini等格式，可供个人或者企业内部管理与分发渠道使用。🍥 The next-generation LLM gateway and AI asset management system supports multiple languages. |
...
| [dreammis/social-auto-upload](https://github.com/dreammis/social-auto-upload) | ⭐ 7.3k | 自动化上传视频到社交媒体：抖音、小红书、视频号、tiktok、youtube、bilibili |
...
| [zyronon/TypeWords](https://github.com/zyronon/TypeWords) | ⭐ 5.4k | 练习英语，一次敲击，一点进步；Practice English, one strike, one step forward |
| [dreamhunter2333/cloudflare_temp_email](https://github.com/dreamhunter2333/cloudflare_temp_email) | ⭐ 4.9k | CloudFlare free temp domain email 免费收发 临时域名邮箱 支持附件 IMAP SMTP TelegramBot |
...
| [youhunwl/TVAPP](https://github.com/youhunwl/TVAPP) | ⭐ 4.3k |  收集全网 Android TV电视盒子应用，涵盖影视、直播、K歌、工具、游戏等类型，整理优质APK资源，支持便捷下载与自动更新。提供安全验证、分类索引与兼容性标注，助力用户打造家庭影音娱乐中心！              ✅ TVBox/影视仓等影音壳接口配置源。 |
...
| [vercel/streamdown](https://github.com/vercel/streamdown) | ⭐ 3.0k | A drop-in replacement for react-markdown, designed for AI-powered streaming. |
...
| [liu-ziting/what-to-eat](https://github.com/liu-ziting/what-to-eat) | ⭐ 2.5k | 一饭封神：一个基于 AI 的智能菜谱生成平台，支持中华八大菜系 + 国际料理，提供营养分析、酒水推荐、菜谱效果图生成等全方位烹饪指导。 |
...
| [neovateai/neovate-code](https://github.com/neovateai/neovate-code) | ⭐ 1.0k | Neovate Code is a code agent to enhance your development. You can use it to generate code, fix bugs, review code, add tests, and more. You can run it in interactive mode or headless mode. |
...
| [vue-final/vue-final-modal](https://github.com/vue-final/vue-final-modal) | ⭐ 998 | 🍕Vue Final Modal is a tiny, renderless, mobile-friendly, feature-rich modal component for Vue.js. |
...
| [antfu/antfu.me](https://github.com/antfu/antfu.me) | ⭐ 980 | My personal website |
| [antfu/changelogithub](https://github.com/antfu/changelogithub) | ⭐ 873 | Generate changelog for GitHub |
...
| [aklinker1/vite-plugin-web-extension](https://github.com/aklinker1/vite-plugin-web-extension) | ⭐ 813 | Vite plugin for developing Chrome/Web Extensions |
| [kermanx/reactive-vscode](https://github.com/kermanx/reactive-vscode) | ⭐ 795 | Vue Reactivity for VSCode Extension API |
| [klover2/wechatpay-node-v3-ts](https://github.com/klover2/wechatpay-node-v3-ts) | ⭐ 743 | 微信支付v3 |
...
| [SnowingFox/open-nof1.ai](https://github.com/SnowingFox/open-nof1.ai) | ⭐ 714 | A opensource AI trading platform in real market, |
| [uiwjs/react-login-page](https://github.com/uiwjs/react-login-page) | ⭐ 673 | Some `react` login pages, which can be used quickly after installation. |
| [sakitam-fdd/wind-layer](https://github.com/sakitam-fdd/wind-layer) | ⭐ 664 | :flags: :rocket: wind-layer \| a openlayers && maptalks && amap && bmap && leaflet && mapbox-gl && maplibre-gl extension like windy.com for weather visualization |
...
| [worryzyy/HowToCook-mcp](https://github.com/worryzyy/HowToCook-mcp) | ⭐ 649 | 基于Anduin2017 / HowToCook （程序员在家做饭指南）的mcp server |
...
| [BayBreezy/ui-thing](https://github.com/BayBreezy/ui-thing) | ⭐ 578 | A modern set of Nuxt components built with Reka UI & TailwindCSS. Inspired by shadcn/ui & shadcn-vue. |
| [azl397985856/automate-everything](https://github.com/azl397985856/automate-everything) | ⭐ 550 | 这是我准备写的第一本书，其实早些时候已经打算开始写书了，只是苦于没有写书经验，无从下手。写书不同于博客，写书需要将知识，经验等系统化地讲述出来，而我现在恰巧缺乏这种表现能力。因此我决定在这里将项目中零散的东西记录下来，然后后期润色一下，写成一本书。 |
| [cheeaun/puppetron](https://github.com/cheeaun/puppetron) | ⭐ 544 | Puppeteer (Headless Chrome Node API)-based rendering solution. |
| [MrWangJustToDo/git-diff-view](https://github.com/MrWangJustToDo/git-diff-view) | ⭐ 541 | A Diff View component for React / Vue / Solid / Svelte / Ink, same as Github |
| [dianprata/nuxt-shadcn-dashboard](https://github.com/dianprata/nuxt-shadcn-dashboard) | ⭐ 534 | Template Dashboard with Nuxt 4 + Shadcn + TailwindCSS 4  |
| [antfu-collective/birpc](https://github.com/antfu-collective/birpc) | ⭐ 527 | Message-based two-way remote procedure call. |
| [ImgEdify/Awesome-GPT4o-Image-Prompts](https://github.com/ImgEdify/Awesome-GPT4o-Image-Prompts) | ⭐ 492 | 📚 GPT4o Prompts Dictionary \| Curated Collection of AI Image Generation Prompts |
| [antfu/starter-vscode](https://github.com/antfu/starter-vscode) | ⭐ 489 | Starter template for VS Code Extension |
| [ddiu8081/bus-vis](https://github.com/ddiu8081/bus-vis) | ⭐ 486 | 🚌 City bus visualizations of China. |
| [espressif/esp-brookesia](https://github.com/espressif/esp-brookesia) | ⭐ 480 | ESP-Brookesia is a human-machine interaction development framework designed for AIoT devices. |
...
| [tam315/react-compare-image](https://github.com/tam315/react-compare-image) | ⭐ 397 | React component to compare two images with a slider |
| [junian/markdown-resume](https://github.com/junian/markdown-resume) | ⭐ 337 | ATS and Human-friendly Resume Writer in Markdown. |
| [reslear/tailwind-scrollbar-hide](https://github.com/reslear/tailwind-scrollbar-hide) | ⭐ 299 | tailwindcss plugin for hide scrollbar |
| [antfu/dotfiles](https://github.com/antfu/dotfiles) | ⭐ 278 | My dotfiles |
...
| [howoii/SmartBookmark](https://github.com/howoii/SmartBookmark) | ⭐ 216 | 一款基于 AI 的智能书签管理插件 |
...
| [Alanrk/TabMark-Bookmark-New-Tab](https://github.com/Alanrk/TabMark-Bookmark-New-Tab) | ⭐ 213 | TabMark是一款基于书签的新标签页插件，将你的收藏夹变成新标签页，让你收藏的书签一目了然、整洁高效，快速直达你最需要的网站和资源。搭配智能 AI 搜索，更快找到你想要的答案。支持 Chrome 和 Edge。 |
...
| [antfu/vite-plugin-restart](https://github.com/antfu/vite-plugin-restart) | ⭐ 202 | Custom files/globs to restart Vite server |
