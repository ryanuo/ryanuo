...
自动生成于 5/18/2026, 3:32:40 AM。


| 项目 | Star | 描述 |
| ---- | ---- | ---- |
| [sindresorhus/awesome](https://github.com/sindresorhus/awesome) | ⭐ 467k | 😎 Awesome lists about all kinds of interesting topics |
| [freeCodeCamp/freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp) | ⭐ 445k | freeCodeCamp.org's open-source codebase and curriculum. Learn math, programming, and computer science for free. |
| [public-apis/public-apis](https://github.com/public-apis/public-apis) | ⭐ 436k | A collective list of free APIs |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | ⭐ 373k | Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞  |
| [vinta/awesome-python](https://github.com/vinta/awesome-python) | ⭐ 298k | An opinionated list of Python frameworks, libraries, tools, and resources |
...
| [torvalds/linux](https://github.com/torvalds/linux) | ⭐ 234k | Linux kernel source tree |
...
| [n8n-io/n8n](https://github.com/n8n-io/n8n) | ⭐ 188k | Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations. |
| [affaan-m/everything-claude-code](https://github.com/affaan-m/everything-claude-code) | ⭐ 186k | The agent harness performance optimization system. Skills, instincts, memory, security, and research-first development for Claude Code, Codex, Opencode, Cursor and beyond. |
...
| [ollama/ollama](https://github.com/ollama/ollama) | ⭐ 172k | Get up and running with Kimi-K2.5, GLM-5, MiniMax, DeepSeek, gpt-oss, Qwen, Gemma and other models. |
| [AUTOMATIC1111/stable-diffusion-webui](https://github.com/AUTOMATIC1111/stable-diffusion-webui) | ⭐ 163k | Stable Diffusion web UI |
| [langgenius/dify](https://github.com/langgenius/dify) | ⭐ 142k | Production-ready platform for agentic workflow development. |
| [open-webui/open-webui](https://github.com/open-webui/open-webui) | ⭐ 138k | User-friendly AI Interface (Supports Ollama, OpenAI API, ...) |
...
| [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) | ⭐ 121k | 🔥 Search, scrape, and clean the web for AI agents. |
| [shadcn-ui/ui](https://github.com/shadcn-ui/ui) | ⭐ 115k | A set of beautifully-designed, accessible components and a code distribution platform. Works with your favorite frameworks. Open Source. Open Code. |
...
| [Comfy-Org/ComfyUI](https://github.com/Comfy-Org/ComfyUI) | ⭐ 113k | The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface. |
...
| [immich-app/immich](https://github.com/immich-app/immich) | ⭐ 101k | High performance self-hosted photo and video management solution. |
...
| [browser-use/browser-use](https://github.com/browser-use/browser-use) | ⭐ 94k | 🌐 Make websites accessible for AI agents. Automate tasks online with ease. |
| [oven-sh/bun](https://github.com/oven-sh/bun) | ⭐ 92k | Incredibly fast JavaScript runtime, bundler, test runner, and package manager – all in one |
| [ruanyf/weekly](https://github.com/ruanyf/weekly) | ⭐ 91k | 科技爱好者周刊，每周五发布 |
| [microsoft/playwright](https://github.com/microsoft/playwright) | ⭐ 89k | Playwright is a framework for Web Testing and Automation. It allows testing Chromium, Firefox and WebKit with a single API.  |
...
| [zed-industries/zed](https://github.com/zed-industries/zed) | ⭐ 83k | Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter. |
...
| [OpenCut-app/OpenCut](https://github.com/OpenCut-app/OpenCut) | ⭐ 51k | The open-source CapCut alternative |
...
| [CherryHQ/cherry-studio](https://github.com/CherryHQ/cherry-studio) | ⭐ 46k | AI productivity studio with smart chat, autonomous agents, and 300+ assistants. Unified access to frontier LLMs |
| [zhayujie/CowAgent](https://github.com/zhayujie/CowAgent) | ⭐ 45k | CowAgent (chatgpt-on-wechat) 是基于大模型的超级AI助理，能主动思考和任务规划、访问操作系统和外部资源、创造和执行Skills、通过长期记忆和知识库不断成长，比OpenClaw更轻量和便捷。同时支持微信、飞书、钉钉、企微、QQ、公众号、网页等接入，可选择DeepSeek/OpenAI/Claude/Gemini/ MiniMax/Qwen/GLM/LinkAI，能处理文本、语音、图片和文件，可快速搭建个人AI助理和企业数字员工。 |
...
| [QuantumNous/new-api](https://github.com/QuantumNous/new-api) | ⭐ 34k | A unified AI model hub for aggregation & distribution. It supports cross-converting various LLMs into OpenAI-compatible, Claude-compatible, or Gemini-compatible formats. A centralized gateway for personal and enterprise model management. 🍥 |
...
| [youhunwl/TVAPP](https://github.com/youhunwl/TVAPP) | ⭐ 17k |  收集全网 Android TV电视盒子应用，涵盖影视、直播、K歌、工具、游戏等类型，整理优质APK资源，支持便捷下载与自动更新。提供安全验证、分类索引与兼容性标注，助力用户打造家庭影音娱乐中心！              ✅ TVBox/影视仓等影音壳接口配置源。 |
...
| [langbot-app/LangBot](https://github.com/langbot-app/LangBot) | ⭐ 16k | Production-grade platform for building agentic IM bots - 生产级多平台智能机器人开发平台. 提供 Agent、知识库编排、插件系统 / Bots for Discord / Slack / LINE / Telegram / WeChat(企业微信, 企微智能机器人, 公众号) / 飞书 / 钉钉 / QQ / Satori e.g. Integrated with ChatGPT(GPT), DeepSeek, Dify, n8n, Langflow, Coze, Claude, Gemini, MiniMax, Ollama, SiliconFlow, Moonshot, GLM, openclaw / hermes agent |
...
| [NanmiCoder/cc-haha](https://github.com/NanmiCoder/cc-haha) | ⭐ 11k | Claude Code 泄露源码 - 本地可运行版本，新增跨平台桌面端软件补齐Computer Use（附带核心模块解析） |
...
| [unovue/shadcn-vue](https://github.com/unovue/shadcn-vue) | ⭐ 10.0k | Vue port of shadcn-ui |
...
| [dreamhunter2333/cloudflare_temp_email](https://github.com/dreamhunter2333/cloudflare_temp_email) | ⭐ 9.4k | CloudFlare free temp domain email 免费收发 临时域名邮箱 支持附件 IMAP SMTP TelegramBot |
...
| [antfu/starter-ts](https://github.com/antfu/starter-ts) | ⭐ 909 | Starter template for TypeScript library |
...
| [worryzyy/HowToCook-mcp](https://github.com/worryzyy/HowToCook-mcp) | ⭐ 718 | 基于Anduin2017 / HowToCook （程序员在家做饭指南）的mcp server |
...
| [MrWangJustToDo/git-diff-view](https://github.com/MrWangJustToDo/git-diff-view) | ⭐ 695 | A Diff View component for React / Vue / Solid / Svelte / Ink, same as Github |
| [BayBreezy/ui-thing](https://github.com/BayBreezy/ui-thing) | ⭐ 694 | A modern set of Nuxt components built with Reka UI & TailwindCSS. Inspired by shadcn/ui & shadcn-vue. |
...
| [uiwjs/react-login-page](https://github.com/uiwjs/react-login-page) | ⭐ 694 | Some `react` login pages, which can be used quickly after installation. |
| [espressif/esp-brookesia](https://github.com/espressif/esp-brookesia) | ⭐ 687 | ESP-Brookesia is a human-machine interaction development framework designed for AIoT devices. |
...
| [dianprata/nuxt-shadcn-dashboard](https://github.com/dianprata/nuxt-shadcn-dashboard) | ⭐ 654 | Template Dashboard with Nuxt 4 + Shadcn + TailwindCSS 4  |
| [junian/markdown-resume](https://github.com/junian/markdown-resume) | ⭐ 568 | ATS and Human-friendly Resume Writer in Markdown. |
...
| [ImgEdify/Awesome-GPT4o-Image-Prompts](https://github.com/ImgEdify/Awesome-GPT4o-Image-Prompts) | ⭐ 551 | 📚 GPT4o Prompts Dictionary \| Curated Collection of AI Image Generation Prompts |
...
| [unjs/undocs](https://github.com/unjs/undocs) | ⭐ 348 | Minimal Documentation theme and CLI for shared usage across UnJS projects. |
| [zebra-ui/zebra-swiper](https://github.com/zebra-ui/zebra-swiper) | ⭐ 328 | 兼容多端的高性能轮播组件库，支持多种复杂的 3D 轮播效果。 |
| [howoii/SmartBookmark](https://github.com/howoii/SmartBookmark) | ⭐ 316 | 一款基于 AI 的智能书签管理插件 |
...
| [antfu/yak-shaving-map](https://github.com/antfu/yak-shaving-map) | ⭐ 100 | Anthony's Yak Shaving Map |
...
| [yuyinws/init-commit](https://github.com/yuyinws/init-commit) | ⭐ 55 | Find the initial commit of a repository. |
