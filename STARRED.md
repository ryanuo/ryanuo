...
| 项目 | Star | 描述 |
| ---- | ---- | ---- |
| [sindresorhus/awesome](https://github.com/sindresorhus/awesome) | ⭐ 470k | 😎 Awesome lists about all kinds of interesting topics |
...
| [public-apis/public-apis](https://github.com/public-apis/public-apis) | ⭐ 437k | A collective list of free APIs |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | ⭐ 374k | Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞  |
| [vinta/awesome-python](https://github.com/vinta/awesome-python) | ⭐ 299k | An opinionated list of Python frameworks, libraries, tools, and resources |
...
| [affaan-m/ECC](https://github.com/affaan-m/ECC) | ⭐ 191k | The agent harness performance optimization system. Skills, instincts, memory, security, and research-first development for Claude Code, Codex, Opencode, Cursor and beyond. |
| [n8n-io/n8n](https://github.com/n8n-io/n8n) | ⭐ 190k | Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations. |
...
| [langgenius/dify](https://github.com/langgenius/dify) | ⭐ 143k | Production-ready platform for agentic workflow development. |
| [open-webui/open-webui](https://github.com/open-webui/open-webui) | ⭐ 139k | User-friendly AI Interface (Supports Ollama, OpenAI API, ...) |
...
| [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) | ⭐ 124k | 🔥 Search, scrape, and clean the web for AI agents. |
...
| [rustdesk/rustdesk](https://github.com/rustdesk/rustdesk) | ⭐ 115k | An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer. |
| [Comfy-Org/ComfyUI](https://github.com/Comfy-Org/ComfyUI) | ⭐ 114k | The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface. |
...
| [immich-app/immich](https://github.com/immich-app/immich) | ⭐ 102k | High performance self-hosted photo and video management solution. |
...
| [browser-use/browser-use](https://github.com/browser-use/browser-use) | ⭐ 95k | 🌐 Make websites accessible for AI agents. Automate tasks online with ease. |
...
| [ruanyf/weekly](https://github.com/ruanyf/weekly) | ⭐ 92k | 科技爱好者周刊，每周五发布 |
...
| [zed-industries/zed](https://github.com/zed-industries/zed) | ⭐ 84k | Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter. |
...
| [OpenCut-app/OpenCut](https://github.com/OpenCut-app/OpenCut) | ⭐ 52k | The open-source CapCut alternative |
...
| [QuantumNous/new-api](https://github.com/QuantumNous/new-api) | ⭐ 35k | A unified AI model hub for aggregation & distribution. It supports cross-converting various LLMs into OpenAI-compatible, Claude-compatible, or Gemini-compatible formats. A centralized gateway for personal and enterprise model management. 🍥 |
...
| [AstrBotDevs/AstrBot](https://github.com/AstrBotDevs/AstrBot) | ⭐ 33k | AI Agent Assistant & development framework that integrates lots of IM platforms, LLMs, plugins and AI feature, and can be your openclaw alternative. ✨ |
...
| [jnMetaCode/agency-agents-zh](https://github.com/jnMetaCode/agency-agents-zh) | ⭐ 13k | 🎭 211 个即插即用的 AI 专家角色 — 支持 Hermes Agent/Claude Code/Cursor/Copilot 等 16 种工具，覆盖工程/设计/营销/金融等 18 个部门。含 46 个中国市场原创智能体（小红书/抖音/微信/飞书/钉钉等） |
...
| [dreamhunter2333/cloudflare_temp_email](https://github.com/dreamhunter2333/cloudflare_temp_email) | ⭐ 9.6k | CloudFlare free temp domain email 免费收发 临时域名邮箱 支持附件 IMAP SMTP TelegramBot |
...
| [tushen6/Tomorrow](https://github.com/tushen6/Tomorrow) | ⭐ 1.7k | tvbox OK影视 影视仓 配置接口 数据来源于网络 仅供测试 |
...
| [pixpark/picprose](https://github.com/pixpark/picprose) | ⭐ 754 | Better cover image generator tool for Medium, Blog, Youtube, BiliBili and many others |
...
| [chibivue-land/chibivue](https://github.com/chibivue-land/chibivue) | ⭐ 714 | chibivue is a minimal vuejs/core implementations (reactivity, virtual dom, component runtime, compiler, vapor, ssr, store, router, language tools). An online book for building your own Vue.js. |
| [MrWangJustToDo/git-diff-view](https://github.com/MrWangJustToDo/git-diff-view) | ⭐ 701 | A Diff View component for React / Vue / Solid / Svelte / Ink, same as Github |
| [sakitam-fdd/wind-layer](https://github.com/sakitam-fdd/wind-layer) | ⭐ 695 | :flags: :rocket: wind-layer \| a openlayers && maptalks && amap && bmap && leaflet && mapbox-gl && maplibre-gl extension like windy.com for weather visualization |
| [espressif/esp-brookesia](https://github.com/espressif/esp-brookesia) | ⭐ 694 | ESP-Brookesia is a human-machine interaction development framework designed for AIoT devices. |
...
| [BayBreezy/ui-thing](https://github.com/BayBreezy/ui-thing) | ⭐ 693 | A modern set of Nuxt components built with Reka UI & TailwindCSS. Inspired by shadcn/ui & shadcn-vue. |
...
| [dianprata/nuxt-shadcn-dashboard](https://github.com/dianprata/nuxt-shadcn-dashboard) | ⭐ 659 | Template Dashboard with Nuxt 4 + Shadcn + TailwindCSS 4  |
| [junian/markdown-resume](https://github.com/junian/markdown-resume) | ⭐ 577 | ATS and Human-friendly Resume Writer in Markdown. |
| [antfu-collective/birpc](https://github.com/antfu-collective/birpc) | ⭐ 563 | Message-based two-way remote procedure call. |
| [ImgEdify/Awesome-GPT4o-Image-Prompts](https://github.com/ImgEdify/Awesome-GPT4o-Image-Prompts) | ⭐ 561 | 📚 GPT4o Prompts Dictionary \| Curated Collection of AI Image Generation Prompts |
...
| [unjs/undocs](https://github.com/unjs/undocs) | ⭐ 349 | Minimal Documentation theme and CLI for shared usage across UnJS projects. |
| [zebra-ui/zebra-swiper](https://github.com/zebra-ui/zebra-swiper) | ⭐ 329 | 兼容多端的高性能轮播组件库，支持多种复杂的 3D 轮播效果。 |
| [howoii/SmartBookmark](https://github.com/howoii/SmartBookmark) | ⭐ 321 | 一款基于 AI 的智能书签管理插件 |
...
| [Hui404/CoreScribe](https://github.com/Hui404/CoreScribe) | ⭐ 20 |  |
...
| [kkwell/DBT-Agent-Plugins](https://github.com/kkwell/DBT-Agent-Plugins) | ⭐ 5 | 基于大模型的硬件开发智能体插件。对话生成代码，自动完成交叉编译与一键部署。 |
